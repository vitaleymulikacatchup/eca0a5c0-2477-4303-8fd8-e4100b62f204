...
export const metadata: Metadata = {
  title: "Grandeur Hotel - Luxury Accommodation & 5-Star Experience",
  description: "Experience unparalleled luxury at Grandeur Hotel. World-class amenities, elegant suites, fine dining, and exceptional service await.",
  keywords: "luxury hotel, 5-star accommodation, premium suites, spa, fine dining, concierge service",
  metadataBase: new URL("https://grandeur-hotel.com"),
  alternates: {
    canonical: "https://grandeur-hotel.com"
  },
  openGraph: {
    title: "Grandeur Hotel - Luxury Accommodation & 5-Star Experience",
    description: "Experience unparalleled luxury at Grandeur Hotel. World-class amenities, elegant suites, fine dining, and exceptional service await.",
